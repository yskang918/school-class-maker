...
# 사이드바 없이 넓은 화면 사용
st.set_page_config(page_title="반편성 프로그램 v40.4 (Final)", layout="wide", initial_sidebar_state="collapsed") 
...
def show_help_popup():
    ...
    <div class="info-box">
        <div class="info-title">2. 👯‍♀️ 쌍생아 분반/합반 로드밸런싱</div>
        <div class="info-desc">합반/분반 희망을 지키며, <b>특정 반에 쌍생아가 몰리지 않도록</b> 분산 배정합니다.</div>
    </div>
    ...
    <div class="info-box">
        ...
        <div class="info-desc">해당 학급은 인원을 적게, <b>특수/통합 학생끼리는 겹치지 않게</b> 분산합니다.</div>
    </div>
    """, unsafe_allow_html=True)

st.title("🏫 반편성 프로그램 (v40.4)")
